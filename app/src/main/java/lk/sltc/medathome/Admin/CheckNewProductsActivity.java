                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0){
                                    ...
                                    Toast.makeText(CheckNewProductsActivity.this, "The service is deleted successfully.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        builder.show();
    ...
    private void ChangeProductState(String productID) {
        unverifiedProductsRef.child(productID).child("productState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(CheckNewProductsActivity.this, "Service has been Approved", Toast.LENGTH_SHORT).show();
            }
        });
    }
}