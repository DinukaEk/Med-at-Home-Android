...
import lk.sltc.medathome.ViewHolder.SellerViewHolder;
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0){
                                    ...
                                    Toast.makeText(SellersProductsActivity.this, "The service is deleted successfully.", Toast.LENGTH_SHORT).show();
                                }
                                else if (which == 1){
