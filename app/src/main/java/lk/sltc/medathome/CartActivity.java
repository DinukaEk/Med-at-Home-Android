...
import lk.sltc.medathome.Model.Cart;
import lk.sltc.medathome.Prevalent.Prevalent;
import lk.sltc.medathome.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                holder.txtProductQuantity.setText("No. of weeks = " + model.getQuantity());
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        Toast.makeText(CartActivity.this, "Service removed successfully", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                                }
